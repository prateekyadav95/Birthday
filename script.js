...
// Function to type out message (Hindi + English)
function typeMessage() {
    const messages = [
        `मेरी प्यारी दीदी ${userName},`,
        "आपका जन्मदिन मेरे लिए सबसे खास दिन है।",
        "आपकी मुस्कान मेरी सारी परेशानियाँ दूर कर देती है।",
        "आपका साथ मेरी सबसे बड़ी ताकत है।",
        "भगवान आपको हमेशा खुश रखे और आपकी सारी इच्छाएँ पूरी हों।",
        "आप जैसी बहन पाकर मैं खुद को बहुत लकी मानता हूँ।",
